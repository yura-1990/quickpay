<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
    <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
            ...
            @if (auth()->user()->can('Browse Roles') || auth()->user()->hasRole('supper-admin'))
                <li class="relative px-6 py-3">
            ...
            @endif
            @if (auth()->user()->can('Browse Permissions') || auth()->user()->hasRole('supper-admin'))
                <li class="relative px-6 py-3">
            ...
            @endif
            @if (auth()->user()->can('Browse Users') || auth()->user()->hasRole('supper-admin'))
                <li class="relative px-6 py-3">
